            ...
            return (
              ...
              >
                ...
                <div className={`w-full lg:w-[calc(50%-100px)] ${isEven ? 'lg:text-right' : 'lg:text-left'} pl-24 lg:pl-0`}>
                  ...
                  >
                    <div className={`inline-flex items-center gap-3 mb-6 text-[10px] font-black uppercase tracking-[0.3em] ${completed ? 'text-accent-glow' : unlocked ? 'text-accent-glow' : 'text-text-muted'}`}>
                    ...
                    <h3 className={`text-4xl md:text-5xl font-serif italic mb-6 transition-all duration-500 ${unlocked ? 'text-text-primary group-hover:text-accent-glow' : 'text-text-muted/20'}`}>
                      {node.title}
                    </h3>
