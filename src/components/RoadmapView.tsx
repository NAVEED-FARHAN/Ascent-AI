            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className={`absolute left-[34px] lg:left-1/2 -translate-x-1/2 top-0 w-20 h-20 rounded-2xl border-2 flex items-center justify-center transition-all duration-700 z-20 ${completed
