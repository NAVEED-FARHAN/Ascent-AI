...
export default function Dashboard({ roadmap, progress }: DashboardProps) {
  ...
  return (
    <div className="max-w-[1240px] w-full mx-auto px-6 md:px-10 pt-12 pb-32 space-y-0 relative divide-y divide-white/[0.06]">
      ...
      <header className="pb-10 relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.45em] text-accent-glow/80">
        ...
        <div className="flex flex-wrap items-center gap-6 md:gap-8">
          <div className="hidden lg:flex items-center gap-6 text-[10px] font-mono text-text-muted/40 uppercase tracking-wider">
          ...
          >
             <div className="text-left">
               <p className="text-[9px] font-black text-text-muted/50 uppercase tracking-widest mb-0.5">Ranking</p>
               <p className="text-[12px] font-black text-text-primary uppercase tracking-widest leading-none">
             ...
             <div className="text-left">
               <p className="text-[9px] font-black text-text-muted/50 uppercase tracking-widest mb-0.5">Sync State</p>
               <div className="flex items-center gap-1.5">
                 <div className="w-1.5 h-1.5 rounded-full bg-accent-success animate-pulse" />
                 <p className="text-[10px] font-bold text-accent-success uppercase tracking-wider">Active</p>
               </div>
             </div>
          </motion.div>
        </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 py-12 gap-8 lg:gap-0">
        ...
        <div className="lg:col-span-4 flex items-center gap-6 lg:pr-8">
          <div className="relative w-44 h-44 shrink-0">
             ...
             <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-4xl font-serif italic text-text-primary leading-none tracking-tight">{progressPercent}%</span>
                <span className="text-[9px] font-black text-text-muted uppercase tracking-[0.3em] mt-1.5">Mastery</span>
             </div>
          </div>

          <div className="space-y-3 flex-1">
            <span className="text-[10px] font-black text-text-muted/50 uppercase tracking-widest block">Core Telemetry</span>
        ...
        <div className="lg:col-span-5 flex flex-col justify-between lg:px-10 lg:border-r lg:border-white/[0.06] space-y-6 lg:space-y-0">
          ...
          <div className="grid grid-cols-3 gap-6 pt-4 border-t border-white/[0.05]">
             <div className="space-y-1.5">
                <p className="text-[10px] font-black text-text-muted/50 uppercase tracking-widest">Time Delta</p>
                <p className="text-2xl font-serif italic text-text-primary">{calculateHoursSpent()} <span className="text-[10px] uppercase font-bold opacity-45">Hrs</span></p>
             </div>
             <div className="space-y-1.5">
                <p className="text-[10px] font-black text-text-muted/50 uppercase tracking-widest">Streak</p>
                <p className="text-2xl font-serif italic text-accent-glow">{progress.currentStreak} <span className="text-[10px] uppercase font-bold opacity-45">Days</span></p>
             </div>
             <div className="space-y-1.5">
                <p className="text-[10px] font-black text-text-muted/50 uppercase tracking-widest">Nodes Set</p>
                <p className="text-2xl font-serif italic text-text-primary">{completedSubTopics}</p>
             </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3 lg:pl-10 flex flex-col justify-center space-y-4">
          <div className="flex items-center justify-between pb-2 border-b border-white/[0.04]">
             <h3 className="text-sm font-black uppercase tracking-widest text-text-primary opacity-80">Sequence Logic</h3>
          ...
          <div className="space-y-3">
             {[
               ...
               <div key={m.id} className={`flex items-center gap-3.5 ${progressPercent >= m.min ? 'opacity-100' : 'opacity-25'}`}>
                  <span className="text-[10px] font-mono text-accent-glow/70">{m.id}</span>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 py-12 gap-8 lg:gap-0">
        ...
        <div className="lg:col-span-8 lg:pr-10 lg:border-r lg:border-white/[0.06] space-y-5">
          <div className="flex items-center justify-between pb-2 border-b border-white/[0.04]">
            <h3 className="text-sm font-black uppercase tracking-widest text-text-primary opacity-80 flex items-center gap-2">
              <Activity className="w-3.5 h-3.5 text-accent-glow" />
              Consistency Delta
            </h3>
            <div className="flex items-center gap-3">
              <span className="text-[9px] font-bold text-text-muted/40 uppercase tracking-widest">Legend:</span>
              <div className="flex items-center gap-1.5 text-[9px] font-mono text-text-muted">
                <span className="w-2.5 h-2.5 rounded-[1px] bg-white/[0.03]" /> <span>0</span>
                <span className="w-2.5 h-2.5 rounded-[1px] bg-accent-glow/30" /> <span>&lt;3</span>
                <span className="w-2.5 h-2.5 rounded-[1px] bg-accent-glow" /> <span>3+</span>
              </div>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row gap-6 items-start">
            <div className="grid grid-cols-[repeat(auto-fill,minmax(14px,1fr))] gap-2 pt-2 flex-1 w-full">
            ...
            <div className="w-full sm:w-48 space-y-3 shrink-0 pt-2 text-xs font-mono text-text-muted">
              <div className="flex justify-between border-b border-white/[0.03] pb-1">
          ...
          <div className="flex justify-between items-center text-[8px] font-black text-text-muted/30 uppercase tracking-[0.25em] pt-2">
        ...
        <div className="lg:col-span-4 lg:pl-10 flex flex-col justify-center space-y-4">
          <h3 className="text-sm font-black uppercase tracking-widest text-text-primary opacity-80 pb-2 border-b border-white/[0.04]">
            Resource Balance
          </h3>
               ...
               <div key={item.label} className="space-y-1.5">
                  <div className="flex justify-between items-end">
                     <div className="flex flex-col">
                       <span className="text-[10px] font-black uppercase tracking-wider text-text-muted/75">{item.label}</span>
                       <span className="text-[10px] text-text-muted/50 font-mono leading-none">{item.desc}</span>
                     </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 py-12 gap-8 lg:gap-0">
         ...
         <div className="lg:col-span-8 lg:pr-10 lg:border-r lg:border-white/[0.06] flex flex-col justify-center space-y-4">
            <h3 className="text-sm font-black uppercase tracking-widest text-text-primary opacity-80 pb-2 border-b border-white/[0.04] flex items-center gap-2">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-2">
               <div className="flex-1 w-full space-y-2.5">
                  <div className="flex justify-between items-end">
                     <span className="text-[11px] font-black uppercase tracking-widest text-text-muted/50">Laboratory Verification</span>
                     <span className="text-2xl font-serif italic text-text-primary">{progress.practiceScore}%</span>
                  </div>
                  <div className="w-full h-2 bg-white/[0.02] rounded-full overflow-hidden border border-white/[0.04]">
                     <motion.div 
                        initial={{ width: 0 }}
               ...
               <div className="flex items-center gap-8 sm:px-6">
                 <div className="text-center">
                    <p className="text-[10px] font-black text-text-muted/50 uppercase tracking-widest mb-1">Verified</p>
                    <p className="text-lg font-black text-text-primary">{progress.completedChallengeIds.length} / {totalChallengesCount}</p>
                 </div>
                 <div className="text-center">
                    <p className="text-[10px] font-black text-text-muted/50 uppercase tracking-widest mb-1">Quizzes</p>
                    <p className="text-lg font-black text-text-muted">{totalQuizzesCount}</p>
                 </div>
               </div>
            </div>
         </div>
         ...
         <div className="lg:col-span-4 lg:pl-10 flex flex-col justify-center space-y-2.5">
            <div className="space-y-0.5">
               <p className="text-[10px] font-black text-text-muted/50 uppercase tracking-widest italic">Operational Rank</p>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 py-12 gap-8 lg:gap-0">
         ...
         <div className="lg:col-span-8 lg:pr-10 lg:border-r lg:border-white/[0.06] flex flex-col justify-center space-y-4">
            <h3 className="text-sm font-black uppercase tracking-widest text-text-primary opacity-80 pb-2 border-b border-white/[0.04] flex items-center gap-1.5">
               <Terminal className="w-3.5 h-3.5 text-accent-glow" />
               Diagnostic Log Stream
            </h3>
            
            <div className="bg-[#04040d] border border-white/[0.04] rounded-xl p-4 font-mono text-[11px] leading-relaxed text-text-muted/70 space-y-2 h-44 overflow-y-auto">
