  ...
  return (
    <div className="max-w-[1400px] w-full mx-auto px-8 md:px-12 pt-16 pb-40 space-y-0 relative divide-y divide-white/[0.06]">
      ...
      <header className="pb-12 relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
        <div className="space-y-3">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-[11px] md:text-[12px] font-semibold uppercase tracking-[0.35em] text-accent-glow/90">
        ...
        <div className="flex flex-wrap items-center gap-8 md:gap-10">
          ...
          >
             <div className="text-left">
               <p className="text-[10px] md:text-[11px] font-semibold text-text-muted/50 uppercase tracking-[0.2em] mb-0.5">Ranking</p>
               <p className="text-sm md:text-base font-semibold text-text-primary uppercase tracking-widest leading-none">
                 Architect <span className="text-accent-glow font-bold">LVL 0{Math.floor(progressPercent / 10) + 1}</span>
               </p>
             </div>
             <div className="w-[1px] h-8 bg-border-primary" />
             <div className="text-left">
               <p className="text-[10px] md:text-[11px] font-semibold text-text-muted/50 uppercase tracking-[0.2em] mb-0.5">Sync State</p>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 py-16 gap-10 lg:gap-0">
        ...
        <div className="lg:col-span-4 flex items-center gap-8 lg:pr-10">
          <div className="relative w-52 h-52 shrink-0">
             ...
             <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="text-[11px] md:text-xs font-semibold text-text-muted uppercase tracking-[0.3em] mt-2">Mastery</span>
             </div>
          </div>

          <div className="space-y-4 flex-1">
            <span className="text-[11px] md:text-xs font-semibold text-text-muted/50 uppercase tracking-[0.2em] block">Core Telemetry</span>
        ...
        <div className="lg:col-span-5 flex flex-col justify-between lg:px-12 lg:border-r lg:border-border-primary space-y-8 lg:space-y-0">
          <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-6 pt-6 border-t border-border-primary">
             <div className="space-y-2">
                <p className="text-[11px] md:text-xs font-semibold text-text-muted/50 uppercase tracking-[0.15em]">Time Delta</p>
             ...
             <div className="space-y-2">
                <p className="text-[11px] md:text-xs font-semibold text-text-muted/50 uppercase tracking-[0.15em]">Streak</p>
             ...
             <div className="space-y-2">
                <p className="text-[11px] md:text-xs font-semibold text-text-muted/50 uppercase tracking-[0.15em]">Nodes Set</p>
        ...
        <div className="lg:col-span-3 lg:pl-12 flex flex-col justify-center space-y-5">
          <div className="flex items-center justify-between pb-3 border-b border-border-primary">
             <h3 className="text-sm md:text-base font-semibold uppercase tracking-widest text-text-primary">Sequence Logic</h3>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 py-16 gap-10 lg:gap-0">
        ...
        <div className="lg:col-span-8 lg:pr-12 lg:border-r lg:border-white/[0.06] space-y-6">
          <div className="flex items-center justify-between pb-3 border-b border-border-primary">
            <h3 className="text-sm md:text-base font-semibold uppercase tracking-widest text-text-primary flex items-center gap-2">
              <Activity className="w-4 h-4 text-accent-glow" />
              Consistency Delta
            </h3>
            <div className="flex items-center gap-4">
              <span className="text-[11px] md:text-xs font-medium text-text-muted/40 uppercase tracking-widest">Legend:</span>
          ...
          <div className="flex justify-between items-center text-[10px] md:text-[11px] font-semibold text-text-muted/30 uppercase tracking-[0.25em] pt-2">
        ...
        <div className="lg:col-span-4 lg:pl-12 flex flex-col justify-center space-y-5">
          <h3 className="text-sm md:text-base font-semibold uppercase tracking-widest text-text-primary pb-3 border-b border-border-primary">
            Resource Balance
          </h3>
               ...
               <div key={item.label} className="space-y-2">
                  <div className="flex justify-between items-end">
                     <div className="flex flex-col">
                       <span className="text-[11px] md:text-xs font-semibold uppercase tracking-[0.1em] text-text-muted/75">{item.label}</span>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 py-16 gap-10 lg:gap-0">
         ...
         <div className="lg:col-span-8 lg:pr-12 lg:border-r lg:border-white/[0.06] flex flex-col justify-center space-y-5">
            <h3 className="text-sm md:text-base font-semibold uppercase tracking-widest text-text-primary pb-3 border-b border-border-primary flex items-center gap-2">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-8 pt-2">
               <div className="flex-1 w-full space-y-3.5">
                  <div className="flex justify-between items-end">
                     <span className="text-xs font-semibold uppercase tracking-[0.15em] text-text-muted/50">Laboratory Verification</span>
               ...
               <div className="hidden sm:block w-[1px] h-10 bg-border-primary" />
               
               {/* Telemetry metadata block for practice */}
               <div className="flex items-center gap-10 sm:px-8">
                 <div className="text-center">
                    <p className="text-[11px] md:text-xs font-semibold text-text-muted/50 uppercase tracking-[0.15em] mb-1.5">Verified</p>
                    <p className="text-2xl font-semibold text-text-primary leading-none">{progress.completedChallengeIds.length} / {totalChallengesCount}</p>
                 </div>
                 <div className="text-center">
                    <p className="text-[11px] md:text-xs font-semibold text-text-muted/50 uppercase tracking-[0.15em] mb-1.5">Quizzes</p>
                    <p className="text-2xl font-semibold text-text-muted leading-none">{totalQuizzesCount}</p>
                 </div>
               </div>
            </div>
         </div>
         ...
         <div className="lg:col-span-4 lg:pl-12 flex flex-col justify-center space-y-3">
            <div className="space-y-1">
               <p className="text-[11px] md:text-xs font-semibold text-text-muted/50 uppercase tracking-[0.15em] italic">Operational Rank</p>
