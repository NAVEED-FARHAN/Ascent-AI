    ...
    <div className="max-w-[1600px] w-full mx-auto px-6 md:px-12 lg:px-16 pt-12 pb-32 space-y-12 relative">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-4xl md:text-5xl font-serif italic text-text-primary tracking-tight">
              Challenge <span className="text-text-muted font-light font-serif opacity-70">Laboratory</span>
            </h1>
          </div>
      ...
      {allPractice.quizzes.length === 0 && allPractice.challenges.length === 0 ? (
        <section className="py-20 flex flex-col items-center justify-center text-center space-y-6 min-h-[350px] relative overflow-hidden border border-white/[0.06] rounded-3xl bg-white/[0.01]">
          ...
          <div className="space-y-2 max-w-lg px-6">
             <h3 className="text-2xl font-serif italic text-text-primary tracking-tight">Protocol Synchronization Required</h3>
        ...
        <section id="challenges-grid" className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-4">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-white/[0.06]">
              <h3 className="text-xl font-serif italic text-text-primary flex items-center gap-3">
                  ...
                  >
                     <div className="flex justify-between items-start mb-3 gap-4">
                        <div className="space-y-1">
                           ...
                           <h4 className="text-lg font-serif italic text-text-primary">{challenge.title}</h4>
                        </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-6 border-t border-white/[0.06]">
         <div className="lg:col-span-8 space-y-4">
            <h3 className="text-lg font-serif italic text-text-primary">Performance Resonance</h3>
